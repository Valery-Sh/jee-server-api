...
public class TomcatStubHost implements Host {
    ...
    public File getConfigBaseFile() {
        return delegateHost.getConfigBaseFile();

    }

    @Override
    public File getAppBaseFile() {
        return delegateHost.getAppBaseFile();
    }

    @Override
    public String getDomain() {
        return delegateHost.getDomain();

    }

    @Override
    public String getMBeanKeyProperties() {
        return delegateHost.getMBeanKeyProperties();
    }

    @Override
    public File getCatalinaBase() {
        return delegateHost.getCatalinaBase();
    }

    @Override
    public File getCatalinaHome() {
        return delegateHost.getCatalinaHome();
    }
