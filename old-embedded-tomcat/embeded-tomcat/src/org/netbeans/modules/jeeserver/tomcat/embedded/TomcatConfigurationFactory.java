...
public class TomcatConfigurationFactory  implements ModuleConfigurationFactory2 {
    ...
    public ModuleConfiguration create(J2eeModule module, String instanceUrl) throws ConfigurationException {
        String[] paths = new String[] {"META-INF/context.xml"};
        return TomcatModuleConfiguration.getInstance(module, paths,instanceUrl);
