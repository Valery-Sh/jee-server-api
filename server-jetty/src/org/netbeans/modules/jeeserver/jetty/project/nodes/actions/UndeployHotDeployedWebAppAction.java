 ...
 * @author V. Shyshkin
 */
public class UndeployHotDeployedWebAppAction extends AbstractAction implements ContextAwareAction {

    public UndeployHotDeployedWebAppAction() {
    }
    ...
    public Action createContextAwareInstance(Lookup context) {
        return new BaseHotDeployedContextAction(context,"undeployhotdeployed");
    }
