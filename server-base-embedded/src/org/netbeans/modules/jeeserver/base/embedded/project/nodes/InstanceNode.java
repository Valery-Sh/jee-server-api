...
*/
    ...
    /**
     * Created a new instance of the class for the specified server instance.
     *
     * @param uri
     */
    ...
    /**
     * Called when children of the {@code Web Applications} are first asked for
     * nodes. For each child node of the folder named
     * {@literal "server-instance-config"} gets the name of the child file with
     * extension and adds to a List of Strings. Then invokes the method {@literal setKeys(List)
     * }.
     */
    @Override
