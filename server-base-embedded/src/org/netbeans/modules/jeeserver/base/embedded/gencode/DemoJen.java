 ...
 */
package org.netbeans.modules.jeeserver.base.embedded.gencode;
...
public class DemoJen implements CodeGenerator {
     ...
     */
    private DemoJen(Lookup context) { // Good practice is not to save Lookup outside ctor
    ...
    public static class Factory implements CodeGenerator.Factory {
        ...
        public List<? extends CodeGenerator> create(Lookup context) {
            return Collections.singletonList(new DemoJen(context));
        }
    }
